...
- AppImage build target for Linux releases, in addition to the existing tar.gz.

### Fixed
  
  - In windows, no console window opens anymore when doubleclicking on fotobuch-gui.exe
