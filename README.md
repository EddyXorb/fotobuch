  ...
  **Why opinionated?** Every design decision in the layout algorithm reflects a deliberate
  ...
  Also, there are no splashy frames, overlays, smileys, or other distracting objects in the photobook —
  ...
  I am a passionate photographer and I document many of the things that happen around me, as a kind of visual diary. Taking a lot of pictures is easy, but it feels wrong to just shoot them without printing them later and I also love to share memories with my family and friends.
  So every year I sit down and group, rate, post-process and print my photos. In my workflow, the printing is done by creating a photobook and that has always been a pain: the commercial print services normally come with some in-house software solution that does not work well for me (I tried multiple, such as pixum, saal, cewe).
  The pain points usually are:

  - no option to export the photobook to pdf in full size, for sharing, re-printing and as backup
  ...
  - when creating the book it is not possible to automatically add an appendix with metadata for each photo, and since its a masssive amount of work to do it by hand, I omitted this entirely
