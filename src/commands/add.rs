...
mod tests {
    ...
    fn test_deduplicate_empty_list() {
        ...
        let (kept, skipped, warnings) = deduplicate(&mut files, &existing_paths, &existing_hashes, false);
    ...
    fn test_deduplicate_hash_duplicate_allowed() {
        ...
        let (kept, skipped, warnings) = deduplicate(&mut files, &existing_paths, &existing_hashes, true);
